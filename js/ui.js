...
function toggleLoading(isLoading) {
  ...
  if (isLoading) {
    ...
    //icon.attributes.classList.add('fas fa-hourglass-half');
    //document.getElementById('id-bttn').className.valueOf = "fas fa-hourglass-half";
  } else {
    document.getElementById("Search").disabled = false;
    document.getElementById("Search").innerHTML = "Search";
    icon.classList.contains("fas fa-search");
    //document.getElementById('id-bttn').className.valueOf = "fas fa-search";
  }
